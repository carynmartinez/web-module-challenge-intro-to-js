...
function multiply(a,b){
  return a * b;}
console.log (`task 1d:` , (8,8));



console.log (`task 1d:`, (3,7));
...
console.log (`task 2:` , dogYears (40));
...
else if (age < 0.333) {return weight * 0.1;}
...
2. Convert the number of  received to miles
...
console.log (`task 6` , annoyingSong (25));
...
if (number >= 90) {return `you got an A`;}
else if (number < 90 && number >= 80) {return `you got a B`;}
else if (number <80 && number >= 70) {return `you got a C`;}
else if (number <70 && number >= 60) {return `you got a D`;}
else if (number <60) {return `you got an F`;}
